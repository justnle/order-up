...
function Employees() {
  ...
  function submitButtonPressed(event) {
    ...
    if (
      ...
      alert('Please fill in all fields with appropriate input to submit an employee')
    }
  }
  ...
  return (
    <div>
      ...
      <div
        className=" d-flex row justify-content-center align-items-center text-white" id="buttonsDiv">
        <div className="m-1">
